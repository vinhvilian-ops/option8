...
good_block = """                    {/* Content Section: 1 big news, 3 small news below */}
                    <div className="py-2 grid grid-cols-12 gap-8">
                      {/* Left: Main Featured News + 3 Vertical News */}
                      <div className="col-span-8 bg-white rounded-3xl border border-slate-200 shadow-sm flex flex-col p-5">
                        
                        {/* Header without red banner, styled perfectly like homepage */}
                        ...
                        {/* Main Featured News Item */}
                        <div className="h-[500px] sm:h-[580px] relative group w-full cursor-pointer shrink-0 rounded-2xl overflow-hidden">"""
