...
const PILLARS = [
  {
    ...
    subs: [
      ...
      { id: "lanhdao-tr", name: "2.1. Trang riêng Chủ tịch & các Phó Chủ tịch" },
  ...
  },
  {
    ...
    icon: FileText,
    subs: [
      { id: "vandan-cp", name: "1. Chỉ đạo, điều hành của Chính phủ, Thủ tướng" },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "dichvu-tiepnhan", name: "4. Tiếp nhận, trả lời kiến nghị công dân" },
...
const LOCAL_ENTITIES_DATA: Record<string, { title: string, leaders: any[] }> = {
  "Phường Xương Huân": {
    ...
    leaders: [
      { role: "Chủ tịch UBND Phường", name: "Đặng Thị Thùy", detail: "Phụ trách chung chính quyền phường", img: nuChuTichImg },
      { role: "Bí thư Đảng ủy Phường", name: "Nguyễn Văn Hùng", detail: "Chỉ đạo công tác Đảng bộ phường", img: namPctImg },
      { role: "Phó Bí thư Đảng ủy", name: "Trần Minh Quân", detail: "Phụ trách khối dân vận", img: namPctImg },
      { role: "Phó Chủ tịch UBND", name: "Lê Thị Hồng", detail: "Phụ trách Văn hóa - Xã hội", img: nuPctImg }
    ]
  },
  "Xã Vĩnh Ngọc": {
    title: "Lãnh đạo Xã Vĩnh Ngọc",
    leaders: [
      { role: "Chủ tịch UBND Xã", name: "Lê Minh Tuấn", detail: "Điều hành kinh tế - xã hội xã", img: namPctImg },
      { role: "Bí thư Đảng ủy Xã", name: "Trần Thế Quyền", detail: "Chỉ đạo chiến lược phát triển xã", img: namPctImg },
      { role: "Phó Chủ tịch UBND", name: "Nguyễn Văn Nam", detail: "Phụ trách Nông nghiệp - Địa chính", img: namPctImg }
    ]
  },
  "Đặc khu Vân Phong": {
    title: "Lãnh đạo Đặc khu kinh tế Vân Phong",
    leaders: [
      { role: "Trưởng Ban quản lý", name: "Hoàng Ngọc Huy", detail: "Quản lý chiến lược đặc khu", img: namPctImg },
      { role: "Phó Trưởng Ban", name: "Vũ Trọng Đạt", detail: "Phụ trách đầu tư nước ngoài", img: namPctImg },
      { role: "Phó Trưởng Ban", name: "Lê Văn Thắng", detail: "Phụ trách hạ tầng kỹ thuật", img: namPctImg }
    ]
  },
  "Phường Lộc Thọ": {
    title: "Lãnh đạo Phường Lộc Thọ",
    leaders: [
      { role: "Chủ tịch UBND Phường", name: "Trương Văn Bảy", detail: "Quản lý đô thị du lịch", img: namPctImg },
      { role: "Bí thư Đảng ủy Phường", name: "Nguyễn Thị Mai", detail: "Công tác xây dựng hệ thống chính trị", img: nuPctImg }
    ]
  },
  "Xã Cam Hải Đông": {
    title: "Lãnh đạo Xã Cam Hải Đông",
    leaders: [
      { role: "Chủ tịch UBND Xã", name: "Bùi Văn Thành", detail: "Phát triển du lịch Bãi Dài", img: namPctImg },
      { role: "Bí thư Đảng ủy Xã", name: "Phạm Minh Đức", detail: "Chỉ đạo công tác địa phương", img: namPctImg }
    ]
  },
  "Phường Vĩnh Nguyên": {
    title: "Lãnh đạo Phường Vĩnh Nguyên",
    leaders: [
      { role: "Chủ tịch UBND Phường", name: "Ngô Văn Hùng", detail: "Quản lý kinh tế biển đảo", img: namPctImg },
      { role: "Bí thư Đảng ủy Phường", name: "Lê Thị Lan", detail: "Công tác Đảng và Đoàn thể", img: nuPctImg }
    ]
  },
  "Xã Phước Đồng": {
    title: "Lãnh đạo Xã Phước Đồng",
    leaders: [
      { role: "Chủ tịch UBND Xã", name: "Nguyễn Văn Hưởng", detail: "Phát triển nông thôn mới", img: namPctImg },
      { role: "Bí thư Đảng ủy Xã", name: "Trần Văn Cường", detail: "Lãnh đạo chính trị địa phương", img: namPctImg }
    ]
  }
};

const ORG_TABS_DATA: Record<string, { title: string, desc: string, leaders: any[], sectTitle: string, icon: any, image: string }> = {
  "Thường trực Tỉnh ủy": {
    ...
    image: "https://images.unsplash.com/photo-1577493340887-b7bfff550145?q=80&w=600",
    icon: "Building",
    leaders: [
      { role: "Ủy viên Trung ương Đảng\nBí thư Tỉnh ủy", name: "TRẦN PHONG", img: tranPhongImg },
      { role: "Ủy viên dự khuyết Trung ương Đảng\nPhó Bí thư Thường trực Tỉnh ủy", name: "HỒ XUÂN TRƯỜNG", img: hoXuanTruongImg },
      { role: "Phó Bí thư Tỉnh ủy,\nChủ tịch HĐND tỉnh", name: "LÂM ĐÔNG", img: lamDongImg },
      { role: "Phó Bí thư Tỉnh ủy,\nChủ tịch UBND tỉnh", name: "NGUYỄN VIỆT HÙNG", img: nguyenVietHungImg },
      { role: "Phó Bí thư Tỉnh ủy,\nChủ tich UB MTTQ Việt Nam tỉnh", name: "NGUYỄN KHẮC HÀ", img: nguyenKhacHaImg }
    ]
  },
  "Thường trực HĐND tỉnh": {
    ...
    image: "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?q=80&w=600",
    icon: "Users",
    leaders: [
      { role: "Chủ tịch HĐND tỉnh", name: "LÂM ĐÔNG", detail: "Chủ tọa kỳ họp HĐND", img: lamDongImg },
      { role: "Phó Chủ tịch Thường trực HĐND tỉnh", name: "LỮ THANH HẢI", detail: "Phụ trách kinh tế ngân sách HĐND", img: luThanhHaiImg },
      { role: "Phó Chủ tịch HĐND tỉnh", name: "PHẠM THỊ XUÂN TRANG", detail: "Phụ trách Pháp chế", img: phamThiXuanTrangImg }
    ]
  },
  "Lãnh đạo UBND tỉnh": {
    ...
    icon: "User",
    leaders: [
      { role: "Chủ tịch UBND tỉnh", name: "NGUYỄN VIỆT HÙNG", detail: "Phó Bí thư Tỉnh ủy, Chủ tịch UBND tỉnh", img: nguyenVietHungImg, isMain: true },
      { role: "Phó Chủ tịch Thường trực", name: "NGUYỄN LONG BIÊN", detail: "Ủy viên Ban Thường vụ Tỉnh ủy, Phó Chủ tịch Thường trực UBND tỉnh", img: nguyenLongBienImg },
      { role: "Phó Chủ tịch", name: "TRẦN HÒA NAM", detail: "Ủy viên Ban Thường vụ Tỉnh ủy, Phó Chủ tịch UBND tỉnh", img: tranHoaNamImg },
      { role: "Phó Chủ tịch", name: "TRỊNH MINH HOÀNG", detail: "Tỉnh ủy viên, Phó Chủ tịch UBND tỉnh", img: trinhMinhHoangImg },
      { role: "Phó Chủ tịch", name: "LÊ HUYỀN", detail: "Ủy viên Ban Chấp hành Đảng bộ, Phó Chủ tịch UBND tỉnh", img: leHuyenImg },
      { role: "Phó Chủ tịch", name: "NGUYỄN THANH HÀ", detail: "Ủy viên Ban Chấp hành Đảng bộ, Phó Chủ tịch UBND tỉnh", img: nguyenThanhHaImg }
    ]
  },
  "Lãnh đạo xã, phường, đặc khu": {
    ...
    icon: "Map",
    leaders: [
      { role: "Chủ tịch UBND Phường Xương Huân", name: "Đặng Thị Thùy", detail: "Phụ trách chung", img: nuChuTichImg },
      { role: "Bí thư Đảng ủy Phường Xương Huân", name: "Nguyễn Văn Hùng", detail: "Phụ trách công tác Đảng", img: namPctImg },
      { role: "Chủ tịch UBND Xã Vĩnh Ngọc", name: "Lê Minh Tuấn", detail: "Ban quản lý xã", img: namPctImg },
      { role: "Bí thư Đảng ủy Xã Vĩnh Ngọc", name: "Trần Thế Quyền", detail: "Đảng ủy xã", img: namPctImg },
      { role: "Trưởng Ban quản lý Đặc khu kinh tế Vân Phong", name: "Hoàng Ngọc Huy", detail: "Phụ trách Đặc khu kinh tế", img: namPctImg },
      { role: "Phó Trưởng Ban quản lý Đặc khu", name: "Vũ Trọng Đạt", detail: "Phó Trưởng ban", img: namPctImg },
      { role: "Phó Trưởng Ban Nội chính", name: "Phạm Viết Giao", detail: "Ban Nội chính", img: namPctImg }
    ]
  }
};

export const LEADER_PROFILES: Record<string, {
  name: string;
  role: string;
  dob: string;
  hometown: string;
  ...
  "TRẦN HÒA NAM": {
    ...
    ethnicity: "Kinh",
    education: "Kỹ sư Thủy sinh vật học, Kỹ sư Xây dựng công trình; Cử nhân Quản trị kinh doanh",
    politicalTheory: "Cao cấp",
    process: [
  ...
  "LÊ HUYỀN": {
    ...
    hometown: "Tỉnh Gia Lai",
    ethnicity: "Kinh",
    education: "Thạc sĩ Quản lý Kinh tế, Kỹ sư Quản lý đất đai, Cử nhân Hành chính",
    politicalTheory: "Cao cấp",
  ...
  "LÂM ĐÔNG": {
    ...
    hometown: "Gia Lai",
    ethnicity: "Kinh",
    education: "Thạc sĩ Xây dựng Đảng và chính quyền Nhà nước; Cử nhân sư phạm Tiếng Anh; Cử nhân giáo dục chính trị",
    politicalTheory: "Cao cấp",
...
const getLeaderProfile = (leaderName: string, leaderRole: string, imgUrl?: any) => {
...
const MOCK_DOCS = [
  { num: "24/2026/QĐ-UBND", type: "Văn bản QPPL", cat: "vbpq", title: "Quy chuẩn kiến trúc cảnh quan ven biển dải băng Trần Phú - Nha Trang năm 2026", date: "20/05/2026", desc: "Hướng dẫn chỉ tiêu mật độ xây dựng, khoảng lùi hành lang an toàn ven vịnh bảo tồn Nha Trang.", fileText: "Văn bản áp đặt lệnh hạn chế nâng tầng cao vùng đệm bờ biển, tăng tối đa tỷ lệ cây xanh bóng mát." },
  { num: "01/2026/ĐUQT", type: "Điều ước quốc tế", cat: "duqt", title: "Hiệp ước song phương về An ninh Giao thông hàng hải vịnh Nha Trang và vùng phụ cận Đông Nam Á", date: "18/05/2026", desc: "Hợp tác đa phương bảo vệ môi trường sinh thái đại dương và đảm bảo giao thông luồng lạch cảng Cam Ranh.", fileText: "Toàn văn hiệp định cam kết giảm thiểu rác thải nhựa đại dương của tàu tải, tuần tra hỗ trợ ngư dân gặp sự cố." },
  { num: "112/TB-UBND", type: "Thông báo", cat: "tb", title: "Thông báo lịch tổ chức tiếp xúc cử tri và đối thoại doanh nghiệp FDI quý II/2026", date: "15/05/2026", desc: "Thời gian diễn ra vào ngày 05/06/2026 tại Trung tâm Hội nghị 46 Trần Phú nhằm gỡ gỡ vướng mắc đầu tư.", fileText: "Toàn bộ doanh nghiệp trong các KCN và người dân đăng ký qua trang thông tin điện tử trước ngày 30/05." },
  { num: "09/2026/NQ-HĐND", type: "Nghị quyết", cat: "vbpq", title: "Nghị quyết đẩy nhanh chuyển đổi số hành chính công liên huyện Diên Khánh - Cam Ranh", date: "10/05/2026", desc: "Gói hỗ trợ ngân sách 45 tỷ đồng xây dựng trung tâm tích hợp giải dữ liệu dân cư.", fileText: "Bắt buộc 100% hồ sơ đất đai và hộ tịch liên thông trực tuyến, phạt nặng cán bộ chậm trễ." },
  { num: "02/2026/ĐUQT", type: "Điều ước quốc tế", cat: "duqt", title: "Hiệp định Khung hợp tác đầu tư du lịch sinh thái bền vững với Hiệp hội Lữ hành Thế giới", date: "09/05/2026", desc: "Thu hút vốn FDI xanh từ các quỹ tài chính châu Âu nhằm quy hoạch bảo tồn hệ san hô Hòn Mun.", fileText: "Thanh khoản ưu đãi từ nguồn dự phòng xanh của WB đồng tài trợ, giảm phí đóng cảng cho du thuyền chạy bằng hydro sạch." },
  { num: "1450/QĐ-CTUBND", type: "Chỉ đạo điều hành", cat: "ubnd", title: "Quyết định xử phạt vi phạm hành lang bảo trì di tích danh thắng quốc gia Tháp Bà Ponagar", date: "08/05/2026", desc: "Phạt hành chính và cưỡng chế tháo dỡ lấn chiếm hành lang công viên phía Tây tháp.", fileText: "Sở Văn hóa phối hợp UBND TP Nha Trang cưỡng chế hoàn tất trước ngày 25/05/2026." },
  { num: "356/CV-UBND", type: "Văn bản khác", cat: "khac", title: "Công văn phối hợp tăng cường khai thác bay quốc tế từ Hàn Quốc, Trung Quốc đến Cam Ranh", date: "02/05/2026", desc: "Khuyến khích các hãng hàng không mở tuyến mới thông qua giảm phí bãi đỗ mặt đất.", fileText: "Chính sách ưu đãi kéo dài đến hết mùa lễ hội hoa và biển hè 2026." }
];

function LeaderProfileView({ profile, onBack }: { profile: any, onBack: () => void }) {
      ...
      <div className="relative z-10 overflow-hidden flex flex-col md:flex-row items-center text-center md:text-left gap-8 w-full bg-white p-8 sm:p-10 rounded-3xl shadow-2xl border-2 border-red-100 hover:border-red-200 group/main">
        ...
        <div className="relative shrink-0 z-10 w-44 h-44 flex items-center justify-center my-2">
          ...
          <div className="absolute -inset-4 pointer-events-none z-20 opacity-100 flex items-center justify-center">
            ...
            <svg className="absolute w-[124%] h-[124%] animate-spin" style={{ animationDuration: "12s" }} viewBox="0 0 100 100">
              <circle cx="50" cy="50" r="46" fill="none" stroke="#facc15" strokeWidth="0.6" className="opacity-70" />
              <circle cx="50" cy="50" r="46" fill="none" stroke="#facc15" strokeWidth="3" strokeDasharray="6 140" strokeDashoffset="10" className="drop-shadow-[0_0_5px_rgba(250,204,21,0.85)]" />
              <circle cx="50" cy="50" r="46" fill="none" stroke="#facc15" strokeWidth="3" strokeDasharray="6 140" strokeDashoffset="150" className="drop-shadow-[0_0_5px_rgba(250,204,21,0.85)]" />
              <circle cx="50" cy="50" r="41" fill="none" stroke="#facc15" strokeWidth="2.2" strokeDasharray="95 15 30 15 65 15" className="drop-shadow-[0_0_8px_rgba(250,204,21,0.9)] opacity-95" />
            </svg>
            {/* Counter-clockwise rotating layer */}
            <svg className="absolute w-[124%] h-[124%] animate-spin" style={{ animationDuration: "8s", animationDirection: "reverse" }} viewBox="0 0 100 100">
              <circle cx="50" cy="50" r="36" fill="none" stroke="#facc15" strokeWidth="0.8" strokeDasharray="180 15 60 15" className="drop-shadow-[0_0_4px_rgba(250,204,21,0.65)] opacity-85" />
            </svg>
          </div>
      ...
      <div className="relative z-10 space-y-4">
        ...
        <div className="text-lg text-black space-y-2.5 font-bold pl-1">
          <p className="flex items-start gap-1.5">
            <span className="text-red-700 shrink-0 select-none font-bold">-</span>
            <span><strong>Ngày sinh:</strong> {profile.dob}.</span>
          </p>
          <p className="flex items-start gap-1.5">
            <span className="text-red-700 shrink-0 select-none font-bold">-</span>
            <span><strong>Quê quán:</strong> {profile.hometown}.</span>
          </p>
          <p className="flex items-start gap-1.5">
            <span className="text-red-700 shrink-0 select-none font-bold">-</span>
            <span><strong>Dân tộc:</strong> {profile.ethnicity}.</span>
          </p>
          <p className="flex items-start gap-1.5">
            <span className="text-red-700 shrink-0 select-none font-bold">-</span>
            <span><strong>Trình độ:</strong> {profile.education}.</span>
          </p>
          <p className="flex items-start gap-1.5">
            <span className="text-red-700 shrink-0 select-none font-bold">-</span>
            <span><strong>Lý luận chính trị:</strong> {profile.politicalTheory}.</span>
          </p>
          {profile.partyJoinDate && (
            <p className="flex items-start gap-1.5">
              <span className="text-red-700 shrink-0 select-none font-bold">-</span>
              <span><strong>Ngày vào Đảng:</strong> {profile.partyJoinDate}.</span>
            </p>
          )}
        </div>
      </div>
...
export default function GovPortal({ onLeaderClick }: GovPortalProps) {
  ...
  const [selectedLocalEntity, setSelectedLocalEntity] = useState<string>("Phường Xương Huân");
  const [activeLeaderProfile, setActiveLeaderProfile] = useState<any | null>(null);
  ...
  const [selectedDraftTitle, setSelectedDraftTitle] = useState("Dự thảo Quy chuẩn kiến trúc cảnh quan ven biển dải băng Trần Phú - Nha Trang");
  ...
  const [pollResults, setPollResults] = useState({ xaHoi: 64, moiTruong: 22, haTang: 14 });
  ...
  const [formData, setFormData] = useState({ name: "", cardId: "", address: "", desc: "", agreed: false });
  const [appliedCode, setAppliedCode] = useState<string | null>(null);

  // Utility portal states
  const [selectedUtility, setSelectedUtility] = useState<{ group: string, title: string, details: string } | null>(null);
  ...
  const [activeWeeklyNewsId, setActiveWeeklyNewsId] = useState<string | null>(null);
  const [activeDocCategory, setActiveDocCategory] = useState("Văn bản chỉ đạo điều hành");
  ...
  const [qaList, setQaList] = useState([
    { q: "Thời hạn cấp giấy chứng nhận nhận quyền sử dụng đất nông nghiệp là bao lâu?", a: "Theo quy định, không quá 30 ngày kể từ ngày tiếp nhận đủ hồ sơ hợp lệ tại Văn phòng Đăng ký đất đai." },
    { q: "Thủ tục xin cấp phép cải tạo nâng cấp nhà ở riêng lẻ nội đô như thế nào?", a: "Nộp hồ sơ trực tuyến gồm: đơn đề nghị, bản vẽ phương án thiết kế kiến trúc cải tạo và bản sao giấy tờ đất đai sở hữu." }
  ]);

  // Consultation state
  const [consultMessages, setConsultMessages] = useState([
    { sender: "assistant", text: "Chào mừng Quý khách đến với Cổng tham vấn ý kiến nhân dân tỉnh Khánh Hòa. Hãy gửi ý kiến đóng góp hoặc thắc mắc của bạn về các dự thảo quy hoạch mới nhất." }
  ]);
  ...
  const handleSendConsult = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      let replyText = "Xin cảm ơn ý kiến đóng góp quý báu của bạn. Hệ thống đã tiếp nhận nội dung và chuyển thẳng đến tổ soạn thảo Văn bản QPPL của Sở Xây dựng để đối chiếu, phân tích, bổ sung quy hoạch.";
      
      const lowerText = userText.toLowerCase();
      if (lowerText.includes("quy hoạch") || lowerText.includes("biển") || lowerText.includes("nha trang")) {
        replyText = "Cảm ơn Ông/Bà đóng góp về Quy hoạch dải ven biển Nha Trang. Các ý kiến bảo tồn hệ sinh cảnh biển, mở rộng không gian xanh đang được Ban thường vụ xem xét cực kỳ nghiêm túc.";
      } else if (lowerText.includes("y tế") || lowerText.includes("sức khỏe") || lowerText.includes("bệnh viện")) {
        replyText = "Ý kiến về đồng bộ cơ sở dữ liệu hồ sơ sức khỏe điện tử đã được ghi nhận. Sở Y tế đang tích cực tối ưu hóa quy trình liên thông giữa các bệnh viện tuyến đầu.";
      } else if (lowerText.includes("thủ tục") || lowerText.includes("hành chính") || lowerText.includes("một cửa")) {
        replyText = "Ý kiến về cải cách một cửa số đã được chuyển tới Văn phòng UBND tỉnh Khánh Hòa để số hóa và rút ngắn tối đa thời gian xử lý hồ sơ hành chính.";
      }
      
      setConsultMessages(prev => [...prev, { sender: "assistant", text: replyText }]);
    }, 1000);
  };
  ...
  const handleVote = (e: React.FormEvent) => {
    ...
    setVoted(true);
    showNotification("Cảm ơn bạn đã bình chọn! Ý kiến đóng góp đã được ghi nhận trực tiếp.");
  };
  ...
  const handleLookupLandPrice = (e: React.FormEvent) => {
    ...
    const price = streets[landStreet] || "32,000,000 VNĐ / m² (Khu vực lân cận)";
  ...
  const handlePostComment = (e: React.FormEvent) => {
    ...
    setNewComment("");
    showNotification("Gửi ý kiến đóng góp cho dự thảo thành công! Văn phòng sở sẽ tiếp nhận phản hồi.");
  };

  const handlePostQa = (e: React.FormEvent) => {
    e.preventDefault();
    if (!qaInput.trim()) return;
    setQaList(prev => [...prev, { q: qaInput, a: "Hệ thống đã chuyển câu hỏi của bạn đến cơ quan có thẩm quyền liên quan. Chúng tôi sẽ phản hồi bằng văn bản chính thức và cập nhật tại mục Tra cứu trực tuyến trong vòng 3 ngày làm việc." }]);
    setQaInput("");
  ...
  const handleApplyService = (e: React.FormEvent) => {
    ...
    if (serviceStep === 1) {
      ...
      if (!formData.agreed) {
        showNotification("Bạn phải cam kết thông tin khai báo là hoàn toàn đúng sự thật.");
        return;
      }
      const trackingCode = `HSO-${Math.floor(100000 + Math.random() * 900000)}`;
      setAppliedCode(trackingCode);
      showNotification(`Nộp hồ sơ trực tuyến thành công! Mã hồ sơ theo dõi: ${trackingCode}`);
    }
  };
    ...
    <div className="w-full text-left relative">
      ...
      <AnimatePresence>
        {toast && (
          ...
          >
            <CheckCircle size={18} className="text-red-400 shrink-0 animate-bounce" />
            <span>{toast}</span>
          </motion.div>
        )}
      </AnimatePresence>
            ...
            {activePillar.id === "lanhdao" && (
              <div className="space-y-8">
                {/* SECTION 1 (PRIORITY): HOẠT ĐỘNG CỦA LÃNH ĐẠO TỈNH (NỔI BẬT HƠN CẢ) */}
                  ...
                  <div className="flex flex-col gap-0 pt-2 md:pt-4 bg-white rounded-3xl overflow-hidden border border-slate-200">
                  {/* NEW HORIZONTAL NAVIGATION BAR */}
                  <div className="bg-red-900 p-8 flex flex-col lg:flex-row gap-10 items-center justify-between">
                    {/* EMBLEM AND TITLE */}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-1 w-full max-w-5xl ml-auto">
                      {[
                        ...
                        >
                          <div className={activeOrgTab === label ? "text-[#FFF700]" : ""}>
                            {label === "Thường trực Tỉnh ủy" ? <Building size={20} /> : 
                             label === "Thường trực HĐND tỉnh" ? <Users size={20} /> : 
                             label === "Lãnh đạo UBND tỉnh" ? <Contact size={20} /> : 
                             <Map size={20} />}
                          </div>
                          <span className={`whitespace-nowrap ${activeOrgTab === label ? "text-[#FFF700]" : ""}`}>{label}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                    ...
                    {activeOrgTab !== "Lịch công tác" && ORG_TABS_DATA[activeOrgTab] && (
                      activeLeaderProfile ? (
                        <LeaderProfileView 
                      ...
                      <div className="bg-red-700 px-6 py-4 flex justify-between items-center text-white min-h-[80px]">
                        <div className="flex flex-col justify-center">
                          <p className="text-red-100 text-lg font-bold uppercase tracking-widest pl-0.5">Trang tin chi tiết</p>
                          <h3 className="text-2xl font-black uppercase tracking-wider drop-">
                            {ORG_TABS_DATA[activeOrgTab].title.toUpperCase()}
                          </h3>
                        </div>
                        <Building size={32} className="text-red-100 drop- opacity-90" />
                      </div>
                      ...
                      {activeOrgTab === "Lãnh đạo xã, phường, đặc khu" && (
                        <div className="bg-slate-100 p-6 border-b border-slate-200 flex flex-col gap-4">
                          <div className="flex items-center gap-2 text-slate-700 font-black uppercase text-base tracking-wider">
                            ...
                            <span>Danh sách đơn vị hành chính & đặc khu:</span>
                          </div>
                          <div className="flex flex-wrap gap-2">
                            {Object.keys(LOCAL_ENTITIES_DATA).map(entity => (
                              <button
                                key={entity}
                                onClick={() => setSelectedLocalEntity(entity)}
                      ...
                      <div className="bg-slate-50 relative py-10 px-6 md:px-10 overflow-hidden min-h-[550px] flex flex-col justify-center gap-10">
                        ...
                        {/* MAIN LEADER CARD */}
                        {(() => {
                          const leaders = activeOrgTab === "Lãnh đạo xã, phường, đặc khu" 
                            ? LOCAL_ENTITIES_DATA[selectedLocalEntity].leaders 
                          ...
                          return (
                            <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-8 w-full mt-2 bg-white hover:bg-slate-50 transition-all duration-500 p-8 rounded-3xl border border-slate-200 border-l-8 border-l-red-700 group/main overflow-hidden">
                              ...
                              <div className="relative z-10 flex flex-col h-full justify-center mt-2">
                                <h2 className="text-red-700 font-black text-4xl uppercase tracking-wider mb-2 transition-colors">{mainLeader.name}</h2>
                                <p className="text-black font-bold text-xl leading-relaxed whitespace-pre-line max-w-xl mb-6">{mainLeader.role}</p>
                                <button onClick={() => {
                                  if (onLeaderClick) {
                                    onLeaderClick(mainLeader);
                                  } else {
                                    setActiveLeaderProfile(getLeaderProfile(mainLeader.name, mainLeader.role, mainLeader.img));
                                  }
                        ...
                        {(() => {
                          ...
                          return (
                            <div className={`relative z-10 grid gap-6 w-full mb-4 ${
                              (() => {
                              ...
                              {subLeaders.map((leader, i) => (
                                <div key={i} className="relative overflow-hidden flex flex-col items-center text-center gap-5 bg-white hover:bg-slate-50 transition-all duration-300 px-3 sm:px-4 lg:px-2 xl:px-4 py-6 rounded-2xl border border-slate-200 border-l-4 border-l-red-700 hover: flex-1 group/sub">
                                  ...
                                  <div className="relative z-10 flex flex-col flex-1 h-full items-center justify-between w-full gap-3">
                                    <div className="flex flex-col items-center w-full">
                                      <h3 className="text-red-700 font-black text-xl uppercase tracking-tight mb-2 transition-colors whitespace-nowrap truncate w-full">{leader.name}</h3>
                                      <div className="flex flex-col items-center justify-center w-full min-h-[44px] gap-1">
                                        {leader.role.split('\n').map((line, idx) => (
                                          <p key={idx} className={`text-black font-bold leading-snug text-base ${idx === 0 && line.includes('Ủy viên') ? 'whitespace-nowrap tracking-tight' : 'text-center'}`}>
                                            {line}
                                          </p>
                                        ))}
                                      </div>
                                    ...
                                    <button onClick={() => {
                                      if (onLeaderClick) {
                                        ...
                                        setActiveLeaderProfile(getLeaderProfile(leader.name, leader.role, leader.img));
                                      }
                    ...
                    <div className="bg-white flex flex-col lg:flex-row items-stretch">
                        ...
                        <div className="h-48 lg:h-auto lg:w-[30%] overflow-hidden relative border-b lg:border-b-0 lg:border-r border-slate-100 bg-slate-50 shrink-0">
                          ...
                          <div 
                            onClick={() => {
                              window.dispatchEvent(new CustomEvent('openWeeklySchedule'));
                            }}
                          ...
                          >
                            <Calendar size={16} className="text-white/80 group-hover/schbtn:text-red-950 transition-colors group-hover/schbtn:scale-110 duration-300" />
                            <span>Lịch làm việc đầy đủ</span>
                            <ArrowRight size={15} className="transform translate-x-0 group-hover/schbtn:translate-x-1.5 transition-transform duration-300 group-hover/schbtn:text-red-950" />
                          </div>
                        </div>
                        ...
                        <div className="p-6 flex flex-col w-full space-y-4">
                          ...
                          <p className="text-lg text-black font-semibold leading-relaxed">
                            Cập nhật thời gian biểu công tác hành chính chính quy cấp tỉnh phối hợp ban công vụ Tỉnh Khánh Hòa.
                          </p>

                          {/* Weekly schedule inline list */}
                          <div className="space-y-3">
                            {[
                              { day: "Thứ Hai (08:00)", event: "Giao ban rà soát giải ngân chỉ tiêu công trình đầu tư trọng điểm" },
                              { day: "Thứ Ba (14:00)", event: "Tiếp đón Ủy ban Xúc tiến Thương mại Hàn Quốc định hướng FDI" },
                              { day: "Thứ Năm (09:00)", event: "Họp tháo gỡ vướng mắc hồ sơ đất đai trực tuyến qua mạng một cửa" }
                            ].map((row, idx) => (
                              <div key={idx} className="text-lg p-3 bg-slate-50 rounded-xl border border-slate-200 flex flex-col gap-1 font-bold">
                                <span className="text-red-700 text-lg font-black">{row.day}</span>
                                <p className="text-black leading-normal font-semibold">{row.event}</p>
                              </div>
                            ))}
                          </div>
                          ...
                          <div className="pt-2">
                            <div className="p-4 bg-slate-100 rounded-2xl border border-slate-200 text-lg text-black leading-relaxed font-bold">
                              🏢 <strong className="text-black">Lịch Tiếp Dân Định Kỳ:</strong> Thứ Năm tuần cuối cùng hàng tháng tại <span className="text-red-700">Ban Tiếp công dân tỉnh, số 2 Ngô Quyền, Nha Trang.</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-span-8 bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                        ...
                        <div className="h-[500px] sm:h-[580px] relative group w-full cursor-pointer shrink-0">
                          ...
                          <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full">
                            <span className="inline-block px-3 py-1.5 bg-red-700 text-white text-lg uppercase font-black tracking-widest rounded-md mb-4 shadow-md">Chỉ đạo nổi bật</span>
                            <h2 className="text-2xl md:text-4xl font-black text-white leading-tight drop-shadow-lg max-w-4xl group-hover:text-yellow-400 transition-colors">Chính phủ ban hành Nghị quyết thúc đẩy tăng trưởng kinh tế vĩ mô, khơi thông nguồn lực đầu tư</h2>
                          </div>
                        </div>
                          ...
                          {[
                            {
                              ...
                              title: "Thủ tướng Chính phủ chỉ đạo khẩn trương hoàn thiện các dự thảo Luật trình Quốc hội",
                              date: "2 giờ trước"
                            },
                            {
                              img: "https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=600",
                              category: "Đối Ngoại Ngoại Giao",
                              title: "Chính phủ chủ động đẩy mạnh hợp tác đối ngoại đa phương và thu hút đầu tư chất lượng",
                              date: "5 giờ trước"
                            },
                            {
                              img: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=600",
                              category: "Phát Triển Số",
                              title: "Đẩy nhanh tiến trình số hóa dịch vụ công quốc gia, xây dựng hạ tầng dữ liệu đồng bộ",
                              date: "8 giờ trước"
                            }
                          ].map((item, idx) => (
                            <div key={idx} className={`flex gap-4 p-4 hover:bg-slate-50 transition-all cursor-pointer group ${idx !== 2 ? 'border-b border-slate-100' : ''}`}>
                              <img src={item.img} alt={item.title} className="w-32 h-24 object-cover rounded-xl shrink-0" />
                              <div className="flex flex-col justify-center">
                                <span className="text-base uppercase font-black text-red-700 mb-1">{item.category}</span>
                                <h6 className="font-bold text-black leading-snug group-hover:text-red-700 transition-colors line-clamp-2">{item.title}</h6>
                                <span className="text-base text-black mt-2">{item.date}</span>
                              </div>
                            </div>
                          ))}
                        </div>
                  ...
                  <div className="mt-10 mb-10 w-screen relative left-1/2 -translate-x-1/2 bg-black border-y border-yellow-400/30 py-12 xl:py-16 overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-4 xl:px-0 relative z-10">
                      <div className="flex items-center w-full mb-6 pl-4 pr-4 lg:pl-8 lg:pr-12 pt-4">
                        <div className="flex items-center gap-3 relative shrink-0 z-10 pr-6">
                          ...
                          <h3 className="text-white text-3xl md:text-[36px] font-black uppercase tracking-tight flex flex-wrap gap-x-1.5 leading-snug">
                            TIN HOẠT ĐỘNG CỦA <span className="text-red-500">LÃNH ĐẠO</span>
                          </h3>
                        </div>
                        ...
                        <button onClick={() => showNotification("Đã mở tất cả hoạt động lãnh đạo")} className="text-white hover:text-red-500 font-bold transition-colors text-lg flex items-center gap-1 shrink-0 pl-6 z-10">
                      ...
                      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:gap-8 px-4 lg:px-8">
                        {/* Left: Big News */}
                        <div className="xl:col-span-7 flex flex-col group cursor-pointer" onClick={() => showNotification("Đã mở bài nổi bật")}>
                          <div className="w-full relative rounded-2xl overflow-hidden shadow-2xl hover:border-[#facc15]/50 border border-white/20 transition-all duration-500 flex-1 aspect-[4/3]">
                            <img src="https://images.unsplash.com/photo-1572025442646-866d16c84a54?q=80&w=1000" alt="News" className="absolute inset-0 w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-700 ease-out" />
                        ...
                        <div className="xl:col-span-5 relative">
                          <div className="xl:absolute xl:inset-0 flex flex-col gap-2.5 bg-black/40 backdrop-blur-md border border-white/10 rounded-3xl p-3 lg:p-4 shadow-xl z-10 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-white/20 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-white/40 transition-colors h-[482px] xl:h-auto">
                            {[
                            {
                              title: "Chủ tịch UBND tỉnh chủ trì phiên họp rà soát quy hoạch...",
                              date: "19/05/2026",
                              img: "https://images.unsplash.com/photo-1572025442646-866d16c84a54?q=80&w=200",
                              active: true
                            },
                            {
                              title: "Phó Chủ tịch thường trực bàn giải pháp tháo gỡ khó khăn về...",
                              date: "18/05/2026",
                              img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=200",
                              active: false
                            },
                            {
                              title: "Đoàn công tác Tỉnh ủy kiểm tra nâng cao hiệu quả cải cách...",
                              date: "18/05/2026",
                              img: "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?q=80&w=200",
                              active: false
                            },
                            {
                              title: "Khánh Hòa sẵn sàng chuẩn bị cho sự kiện Festival Biển Nha...",
                              date: "17/05/2026",
                              img: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=200",
                              active: false
                            },
                            {
                              title: "Hội nghị Ban Chấp hành Đảng bộ tỉnh Khánh Hòa lần thứ 18...",
                              date: "16/05/2026",
                            ...
                            <div 
                              key={idx}
                              onClick={() => showNotification(`Đã mở bài: ${item.title}`)}
                              className={`group flex gap-4 p-2.5 lg:p-3 rounded-2xl items-center cursor-pointer transition-all duration-300 border ${
                                item.active ? "bg-white/20 border-white/30 shadow-md relative" : "bg-transparent border-transparent hover:bg-white/10 hover:border-white/10"
                              }`}
                            >
                              {item.active && (
                              ...
                              <div className="w-[110px] h-[72px] lg:w-[120px] lg:h-[78px] rounded-lg overflow-hidden shrink-0 border border-yellow-400/20 relative">
                                <img src={item.img} alt="Thumbnail" className="w-full h-full object-cover group-hover:scale-105 transition-transform" />
                              </div>
                              <div className="flex-1 min-w-0 pr-1">
                                <h4 className={`text-[16px] lg:text-[17px] font-bold line-clamp-2 leading-snug mb-2 transition-colors ${
                                  item.active ? "text-yellow-400 font-black drop-shadow" : "text-gray-200 group-hover:text-white"
                                }`}>
                                  {item.title}
                                </h4>
                                <div className="flex items-center justify-between">
                                  ...
                                  {item.active && (
                                    <span className="text-[18px] font-black uppercase text-yellow-400 tracking-wider">Đang xem •</span>
                                  )}
                                </div>
                              </div>
                            </div>
                  ...
                  <div className="mt-10 mb-10">
                    ...
                    <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
                      ...
                      <button onClick={() => showNotification("Mở toàn bộ danh mục")} className="hidden md:flex text-red-700 hover:text-red-800 transition-colors text-lg font-bold tracking-wide items-center gap-1 cursor-pointer">
                        Xem toàn bộ danh mục &rarr;
                      </button>
                    </div>

                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:gap-8 hover:cursor-default">
                      {/* Left: Big News (Dark Overlay Layout) */}
                      <div className="xl:col-span-7 flex flex-col group cursor-pointer" onClick={() => showNotification("Đã mở tin nổi bật")}>
                        <div className="w-full h-full relative rounded-2xl overflow-hidden border border-gray-200 shadow-sm flex-1 aspect-[4/3] lg:aspect-auto min-h-[400px]">
                          <img 
                            src="https://images.unsplash.com/photo-1599839619722-39751411ea63?q=80&w=1200&auto=format&fit=crop" 
                            alt="News" 
                            className="absolute inset-0 w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-700 ease-out" 
                          />
                          <div className="absolute inset-0 bg-gradient-to-t from-red-950 via-red-900/70 to-red-900/20 opacity-95"></div>
                          ...
                          <div className="absolute inset-0 p-6 flex flex-col justify-between z-10">
                            ...
                            <div className="flex gap-2">
                              ...
                              <span className="bg-white/20 backdrop-blur-sm text-white text-[18px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-sm">
                                Giao thông & Hạ tầng
                              </span>
                            </div>
                            ...
                            <div className="mt-auto">
                              <div className="flex items-center gap-2 text-[18px] text-yellow-400 font-bold tracking-wide mb-3 bg-red-950/40 w-fit px-3 py-1 rounded-full backdrop-blur-sm">
                                <Calendar size={18} className="opacity-90" />
                                <span>19/05/2026</span>
                              </div>
                              <h3 className="text-2xl lg:text-3xl font-bold text-white mb-3 group-hover:text-yellow-400 transition-colors leading-tight line-clamp-3">
                                Sở GTVT thông báo về việc phân luồng giao thông phục vụ thi công
                              </h3>
                              <p className="text-white/90 line-clamp-2 text-[18px] lg:text-[20px] leading-relaxed mb-6 drop-shadow-sm">
                                Công văn hướng dẫn và văn bản hướng dẫn hành chính điều hành tác nghiệp tại các nút giao thông trọng điểm để đảm bảo an toàn xây dựng và thuận tiện đi lại cho người dân trên địa bàn trong thời gian triển khai dự án nâng cấp đô thị.
                              </p>
                              {/* Content Footer like reference */}
                              <div className="flex justify-between items-center border-t border-white/20 pt-4">
                                <span className="text-yellow-400 text-[18px] font-black tracking-widest uppercase truncate bg-red-950/30 px-3 py-1 rounded-sm">
                                  • Bản tin Sở Ban Ngành •
                                </span>
                                <span className="text-yellow-400 text-[18px] font-bold flex items-center gap-1 hover:text-white transition-colors shrink-0">
                      ...
                      {/* Right: 4 Small with Light Box style */}
                      <div className="xl:col-span-5 flex flex-col gap-4 lg:gap-5 w-full h-full justify-between">
                        {[
                          {
                            title: "UBND tỉnh đánh giá tình hình thực hiện kế hoạch đầu tư công",
                            author: "Sở Kế hoạch và Đầu tư tỉnh Khánh Hòa",
                            date: "19/05/2026",
                            img: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?q=80&w=400"
                          },
                          {
                            title: "Sở Y tế triển khai chiến dịch tiêm chủng mẫu mở rộng",
                            author: "Sở Y tế tỉnh Khánh Hòa",
                            date: "18/05/2026",
                            img: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?q=80&w=400"
                          },
                          {
                            title: "Đoàn thanh tra kiểm tra công tác bảo vệ môi trường tại KCN",
                          ...
                          {
                            title: "Sở Giáo dục công bố điểm thi tốt nghiệp THPT qua ứng dụng mobile",
                            author: "Sở Giáo dục và Đào tạo tỉnh Khánh Hòa",
                            date: "17/05/2026",
                            img: "https://images.unsplash.com/photo-1509062522246-3755977927d7?q=80&w=400"
                          }
                        ].map((item, idx) => (
                          <div key={idx} onClick={() => showNotification("Đã mở tin")} className="group cursor-pointer flex gap-4 bg-white p-4 rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-300 items-stretch h-full">
                            <div className="w-[120px] shrink-0 rounded-lg overflow-hidden relative border border-gray-100 shadow-sm bg-gray-50 h-[80px] self-center">
                              <img src={item.img} alt={item.title} className="w-full h-full object-cover group-hover:scale-[1.05] transition-transform duration-500" />
                            </div>
                            <div className="flex-1 flex flex-col justify-center">
                              <h4 className="text-[18px] lg:text-[20px] font-bold text-red-800 leading-snug group-hover:text-red-700 transition-colors line-clamp-2 mb-2">
                                {item.title}
                              </h4>
                              <span className="text-[18px] text-black font-medium line-clamp-1 mb-2">{item.author}</span>
                              <div className="flex items-center gap-2 text-[18px] text-red-500 font-bold tracking-wide mt-auto">
                  ...
                  <div className="mb-10 flex flex-col gap-6" id="van-ban-qppl-section">
                          ...
                          <button 
                            ...
                            className={`flex items-center gap-2 py-2 px-4 rounded-full cursor-pointer transition-all border whitespace-nowrap text-[18px] font-black shadow-xs ${
                              activeDocCategory === cat 
                                ? 'bg-red-600 border-red-800 text-yellow-400' 
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between bg-white p-5 rounded-2xl gap-4 border border-slate-200 shadow-xs">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="text-red-800 font-black text-[24px] md:text-[28px]">Cơ sở dữ liệu văn bản tỉnh</h3>
                          <p className="text-black text-[18px] font-bold mt-0.5">Cập nhật liên tục 24/7 từ cơ sở dữ liệu chính phủ điện tử tỉnh Khánh Hòa</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 overflow-y-auto max-h-[640px] pr-3 custom-scrollbar-light">
                      {Array.from({ length: 20 }).map((_, idx) => {
                        const prefixes = {
                          "Văn bản chỉ đạo điều hành": ["Chỉ thị", "Quyết định", "Kế hoạch", "Công văn"],
                          "Văn bản quy phạm pháp luật": ["Nghị quyết", "Quyết định", "Chỉ thị"],
                          "Văn bản mới cập nhật": ["Thông báo", "Quyết định", "Kế hoạch", "Chỉ thị"],
                          "Công báo Khánh Hòa": ["Công báo", "Nghị quyết", "Quyết định"],
                          "Thông báo chính thức": ["Thông báo kết luận", "Thông báo nội bộ", "Công văn"],
                          "Văn bản khác": ["Báo cáo", "Tờ trình", "Giấy phép", "Quyết định"]
                        };
                        const defaultPrefixes = ["Dự thảo", "Công văn", "Tờ trình", "Phiếu chuyển"];
                        const currentPrefixes = prefixes[activeDocCategory as keyof typeof prefixes] || defaultPrefixes;
                        ...
                        const rawIdPrefix = type.split(' ')[0].substring(0, 2).toUpperCase();
                        const typeShort = rawIdPrefix === 'TH' ? 'TB' : rawIdPrefix === 'CH' ? 'CT' : rawIdPrefix === 'KẾ' ? 'KH' : rawIdPrefix === 'CÔ' ? 'CV' : rawIdPrefix === 'NG' ? 'NQ' : 'QĐ';
                      
                        return (
                          <div key={idx} className="bg-white p-5 rounded-2xl border border-gray-100 shadow-xs hover:shadow-md hover:border-amber-300 transition-all cursor-pointer group flex flex-col justify-between">
                            <div>
                              <div className="flex items-center justify-between gap-3 mb-3">
                                <span className="text-red-700 bg-red-50 px-2.5 py-1 rounded text-[18px] font-black tracking-wide border border-red-150/50">{1024 + idx}/{typeShort}-UBND</span>
                                <span className="flex items-center gap-1.5 text-black text-[18px] font-bold"><Calendar size={16} className="text-black" /> {`${(30 - (idx % 28)).toString().padStart(2, '0')}/05/2026`}</span>
                              </div>
                              ...
                              <p className="text-black text-[18px] leading-relaxed line-clamp-2 mb-4">
                                Nội dung quy định chi tiết việc triển khai {topic} trên địa bàn toàn tỉnh, yêu cầu các cơ quan ban ngành nghiêm túc thực hiện...
                              </p>
                            </div>
                            <div className="flex items-center justify-between text-[18px] text-black font-bold border-t border-slate-50 pt-3 mt-auto">
                              ...
                              <span className="text-red-700 hover:underline">Chi tiết →</span>
                            </div>
                          </div>
                        );
                      })}
                    ...
                    <button className="mt-6 w-full bg-red-600 text-white py-4 rounded-xl font-black flex items-center justify-center gap-2 hover:bg-red-900 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg shadow-sm text-[20px] group">
                      Truy cập Cổng văn bản chính thức <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                    </button>
                  </div>
                  ...
                  <div className="w-full mt-8 text-left space-y-8">
                    ...
                    <div className="relative overflow-hidden rounded-3xl shadow-md border border-red-700/10 bg-red-900">
                        ...
                        {celebratoryBanners.map((cb, idx) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {/* Footer */}
                              <div className="relative z-20 border-t border-white/20 bg-red-950/90 backdrop-blur-md px-8 py-4 flex gap-4 justify-between items-center text-lg font-black tracking-wider text-yellow-200 shadow-inner">
                                ...
                                <span className="uppercase text-yellow-400/80 hidden lg:inline-block text-base">{cb.footerRight}</span>
                              </div>
                            </motion.div>
                          );
                        })}
            ...
            <div className="mt-10 mb-12">
                  <div className="relative z-10">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 border-b border-slate-200 pb-5">
                      ...
                      <span className="text-lg font-black text-red-700 bg-red-50 border border-red-100 px-3 py-1 rounded-md self-start md:self-auto shrink-0">
                        Số 21/2026
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:gap-8 items-stretch">
                      ...
                      <div className="xl:col-span-7 flex flex-col gap-6">
                        <div 
                          onClick={() => {
                            setActiveWeeklyNewsId(activeWeeklyNewsId === "weekly-big-1" ? null : "weekly-big-1");
                          }}
                          className="w-full relative rounded-2xl border border-slate-200 overflow-hidden group shadow-xs hover:shadow-md transition-all duration-300 cursor-pointer min-h-[440px] md:min-h-[520px] flex flex-col justify-end"
                        >
                          ...
                          {/* Content Layered Inside the Image */}
                          <div className="relative p-5 md:p-6 text-left space-y-2.5 z-10 select-none">
                            {/* Date & Metadata */}
                            ...
                            {/* Large White Title */}
                            <h4 className="text-2xl md:text-3xl font-black text-white leading-tight tracking-tight drop-shadow-md group-hover:text-yellow-400 transition-colors">
                              Thường trực UBND tỉnh định hướng Quy hoạch dải đô thị biển và công viên vịnh Nha Trang
                            </h4>

                            {/* Smooth Collapsible Section inside absolute container */}
                            <AnimatePresence>
                              {activeWeeklyNewsId === "weekly-big-1" && (
                                ...
                                >
                                  <p>
                                    Cuộc họp thu hút đông đảo đại diện từ các Sở Xây dựng, Sở Tài nguyên và Môi trường cùng hiệp hội chuyên gia Kiến trúc đô thị Việt Nam. 
                                    Phát biểu tại phiên thảo luận, Ban Thường trực nhấn mạnh tầm quan trọng của việc duy trì hạ tầng biển hài hòa, giảm thiểu bê tông hóa và tăng thêm ít nhất 25% diện tích công viên công cộng phục vụ người dân bản địa và du khách quốc tế.
                                  </p>
                                  <p>
                                    Hệ thống hành lang giao thông đi bộ dưới lòng đất, các bãi đậu xe ngầm thông minh kết hợp quảng trường nhạc nước sẽ được tích hợp triệt để trong giai đoạn quy hoạch tầm nhìn 2026-2030.
                                  </p>
                                </motion.div>
                              )}
                            </AnimatePresence>
                            ...
                            {/* Bottom actions line */}
                            <div className="flex justify-between items-center pt-2.5 border-t border-white/10 mt-2 text-lg text-red-400 font-black uppercase tracking-wider">
                              ...
                              >
                                <span>{activeWeeklyNewsId === "weekly-big-1" ? "Thu gọn" : "Xem chi tiết bản tin"}</span>
                                <ChevronDown size={11} className={`transition-transform duration-200 ${activeWeeklyNewsId === "weekly-big-1" ? "rotate-180" : ""}`} />
                              </button>
                            </div>
                          </div>
                        </div>
...
{[
                          {
                            ...
                            title: "Sự kiện Quảng bá Xúc tiến du lịch hè xanh Festival Nha Trang 2026",
                            date: "18/05/2026",
                            image: "https://images.unsplash.com/photo-1540553016722-983e48a2cd10?q=80&w=400&fit=crop",
                            detail: "Du lịch Khánh Hòa chính thức khởi động chuỗi hoạt động kích cầu liên kết quốc tế, phấn đấu đón trên 120.000 lượt khách nghỉ dưỡng lữ hành cao cấp quốc tế trải nghiệm dưỡng xanh và hoạt động bảo vệ thiên nhiên biển.",
                            fullText: "Chương trình trọng tâm tập trung vào bảo tồn đa dạng sinh học các rạn san hô Hòn Mun, các hoạt động lặn biển nhặt rác dọn rác nhựa đại dương và thúc đẩy mô hình khách sạn không dùng nhựa một lần tại các resort danh tiếng khép kín ven vịnh Nha Trang."
                          },
                          {
                            id: "weekly-small-2",
                            category: "Cải cách hành chính",
                            source: "Văn phòng Ủy ban nhân dân tỉnh Khánh Hòa",
                            title: "Số hóa quy trình liên thông một cửa số cấp tỉnh và cơ sở hành chính",
                            date: "18/05/2026",
                            image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=400&fit=crop",
                            detail: "Thành phố vinh danh tốp 12 đơn vị xuất sắc tối ưu hóa đạt mốc giảm 40% thời gian thụ lý hồ sơ cấp phép đăng ký kinh doanh và liên thông trực tuyến dữ liệu cư trú.",
                            fullText: "Qua khảo sát độc lập từ bên thứ ba, tỷ lệ người dân hài lòng về thái độ tác phong của cán bộ tại Trung tâm Phục vụ hành chính công đạt mốc kỷ lục 98.4%, khẳng định hiệu quả cao của việc loại bỏ hoàn toàn các nút thắt trung gian phiền hà."
                          },
                          {
                            id: "weekly-small-3",
                            category: "Y tế & Dân sinh",
                            source: "Sở Y tế tỉnh Khánh Hòa",
                            title: "Hồ sơ sức khỏe điện tử đồng bộ dữ liệu quốc gia toàn tỉnh",
                            date: "18/05/2026",
                            image: "https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?q=80&w=400&fit=crop",
                            detail: "Ứng dụng cơ sở dữ liệu y tế dùng chung giúp chia sẻ nhanh chóng kết quả chẩn đoán hình ảnh giữa bệnh viện tỉnh và huyện, nâng cao chất lượng khám cho người nghèo.",
                            fullText: "Người bệnh chỉ cần quẹt mã QR căn cước công dân hoặc VNeID là toàn bộ lịch sử sử dụng thuốc, lịch tiêm ngừa, dị ứng đều hiển thị đầy đủ, giảm thời gian đóng tiền lẻ và giảm thiểu quy trình kê khai giấy tờ thủ công."
                          }
                        ].map((smallItem) => {
                          const isSmallExpanded = activeWeeklyNewsId === smallItem.id;
                          return (
                            <div
                              key={smallItem.id}
                              onClick={() => {
                                setActiveWeeklyNewsId(isSmallExpanded ? null : smallItem.id);
                              }}
                              className={`p-3 rounded-2xl border transition-all duration-300 text-left flex gap-4 cursor-pointer align-start ${
                                isSmallExpanded
                                  ? "bg-slate-50 border-slate-200 shadow-sm"
                                  : "bg-white border-slate-100 hover:shadow-xs hover:border-slate-200/50"
                              }`}
                            >
                              ...
                              <div className="flex-1 min-w-0 flex flex-col justify-between min-h-[72px] md:min-h-[80px]">
                                <div className="space-y-1">
                                  {/* Title: Bold dark red color */}
                                  <h5 className="text-[18px] md:text-xl font-bold text-red-800 leading-snug line-clamp-2 hover:text-red-700 transition-colors">
                                    {smallItem.title}
                                  </h5>
                                ...
                                <AnimatePresence>
                                  {isSmallExpanded && (
                                    ...
                                    >
                                      ...
                                      <p className="text-black">{smallItem.fullText}</p>
                                    </motion.div>
                                  )}
                                </AnimatePresence>
                              </div>
                        ...
                        <div className="flex items-center gap-3 mt-16 mb-6">
                          <h2 className="text-[26px] md:text-[30px] font-black tracking-tight text-red-700 uppercase flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              <span>TIỆN ÍCH DỊCH VỤ & THÔNG TIN CÔNG KHAI</span>
                              <span className="text-[17px] md:text-lg text-black font-medium tracking-normal normal-case mt-0.5">Cơ sở dữ liệu hỗ trợ công dân, doanh nghiệp tra cứu và tương tác trực tuyến</span>
                            </div>
                          </h2>
                        </div>
...
{/* Left Block: 3 Service Cards */}
                        <div className="flex flex-col gap-6 h-full w-full">
                          ...
                          <div className="bg-gradient-to-br from-red-800 to-red-950 rounded-[24px] p-6 text-white shadow-md relative overflow-hidden group hover:shadow-lg transition-all border border-red-950/20 cursor-pointer flex-1 flex flex-col justify-center">
                            <div className="absolute right-0 top-0 w-64 h-64 bg-white/5 rounded-full blur-3xl group-hover:bg-white/10 transition-colors pointer-events-none" />
                            ...
                            <div className="flex items-start justify-between relative z-10">
                              <div className="flex gap-5">
                                <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center shrink-0 border border-white/20 backdrop-blur-md shadow-inner text-yellow-400">
                                  <Monitor size={32} />
                                </div>
                                <div className="flex flex-col justify-center">
                                  <span className="text-lg font-black tracking-widest text-yellow-400 uppercase mb-1 drop-shadow-sm">Thủ tục hành chính</span>
                                  <h3 className="text-[22px] md:text-2xl font-black leading-tight tracking-tight text-white drop-shadow-md">
                                    Dịch vụ trực tuyến
                                  </h3>
                                  <p className="text-lg text-yellow-100/90 font-medium mt-2 max-w-[80%] leading-relaxed">
                                    Hệ thống giải quyết thủ tục hành chính công trực tuyến mức độ 3, 4. Nộp hồ sơ, tra cứu và nhận kết quả tại nhà nhanh chóng, minh bạch.
                                  </p>
                                </div>
                              </div>
                              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center shrink-0 backdrop-blur-md group-hover:bg-white group-hover:text-red-950 transition-all self-center">
                                <ChevronRight size={20} />
                              </div>
                            </div>
                            
                            <div className="mt-6 flex flex-wrap gap-2 lg:gap-3 relative z-10">
                              <span className="bg-black/20 hover:bg-black/30 border border-white/10 text-white text-lg font-bold px-3 py-1.5 rounded-full transition-colors backdrop-blur-sm cursor-pointer whitespace-nowrap">Đăng ký doanh nghiệp</span>
                              <span className="bg-black/20 hover:bg-black/30 border border-white/10 text-white text-lg font-bold px-3 py-1.5 rounded-full transition-colors backdrop-blur-sm cursor-pointer whitespace-nowrap">Cấp phép xây dựng</span>
                              <span className="bg-black/20 hover:bg-black/30 border border-white/10 text-white text-lg font-bold px-3 py-1.5 rounded-full transition-colors backdrop-blur-sm cursor-pointer whitespace-nowrap">Hộ tịch sự kiện</span>
                            </div>
                          </div>

                          {/* Card 2: Tiếp nhận kiến nghị */}
                          <div className="bg-gradient-to-br from-red-900 via-red-950 to-red-900 rounded-[24px] p-6 text-white shadow-md relative overflow-hidden group hover:shadow-lg transition-all border border-red-950/20 cursor-pointer flex-1 flex flex-col justify-center">
                            <div className="absolute right-0 top-0 w-64 h-64 bg-white/5 rounded-full blur-3xl group-hover:bg-white/10 transition-colors pointer-events-none" />
                            <div className="absolute -right-6 -bottom-6 opacity-10 group-hover:scale-110 transition-transform duration-700 pointer-events-none">
                            ...
                            <div className="flex items-start justify-between relative z-10">
                              <div className="flex gap-5">
                                ...
                                <div className="flex flex-col justify-center">
                                  <span className="text-lg font-black tracking-widest text-yellow-400 uppercase mb-1 drop-shadow-sm">Lắng nghe & Giải đáp</span>
                                  <h3 className="text-[22px] md:text-2xl font-black leading-tight tracking-tight text-white drop-shadow-md">
                                    Tiếp nhận, trả lời kiến nghị công dân
                                  </h3>
                                  <p className="text-lg text-yellow-100/90 font-medium mt-2 max-w-[85%] leading-relaxed">
                                    Cổng thông tin tương tác, tiếp nhận phản ánh, kiến nghị của công dân và doanh nghiệp về quy định hành chính, các vấn đề kinh tế - xã hội trên địa bàn tỉnh Khánh Hòa.
                                  </p>
                                </div>
                              </div>
                              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center shrink-0 backdrop-blur-md group-hover:bg-white group-hover:text-red-950 transition-all self-center">
                          ...
                          <div className="bg-gradient-to-br from-red-950 via-red-900 to-red-950 rounded-[24px] p-6 text-white shadow-md relative overflow-hidden group hover:shadow-lg transition-all border border-red-950/20 cursor-pointer flex-1 flex flex-col justify-center">
                            <div className="absolute right-0 top-0 w-64 h-64 bg-white/5 rounded-full blur-3xl group-hover:bg-white/10 transition-colors pointer-events-none" />
                            <div className="absolute -right-6 -bottom-6 opacity-10 group-hover:scale-110 transition-transform duration-700 pointer-events-none">
                              <Globe2 size={140} />
                            </div>
                            ...
                            <div className="flex items-start justify-between relative z-10">
                              <div className="flex gap-5">
                                <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center shrink-0 border border-white/20 backdrop-blur-md shadow-inner text-yellow-400">
                                  <Globe2 size={32} className="text-yellow-300" />
                                </div>
                                <div className="flex flex-col justify-center gap-1">
                                  <span className="text-lg font-black tracking-widest text-yellow-400 uppercase mb-1 drop-shadow-sm">Thỏa thuận ngoại giao</span>
                                  <h3 className="text-[22px] md:text-2xl font-black leading-tight tracking-tight text-white drop-shadow-md">
                                    Điều ước quốc tế
                                  </h3>
                                  <p className="text-lg text-yellow-100/90 font-medium mt-1.5 max-w-[85%] leading-relaxed">
                                    Tra cứu hệ thống các điều ước quốc tế mà nước Cộng hòa Xã hội Chủ nghĩa Việt Nam là thành viên. Thỏa thuận, hiệp định hợp tác song phương và đa phương.
                                  </p>
                                </div>
                              </div>
                              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center shrink-0 backdrop-blur-md group-hover:bg-white group-hover:text-red-950 transition-all self-center">
...
{/* Banner Quảng cáo 1: Phổ biến Giáo dục Pháp luật */}
                  <motion.div
                    ...
                    onClick={() => showNotification("Đang mở Cổng thông tin tuyên truyền Phổ biến Giáo dục Pháp luật...")}
                  ...
                  >
                    ...
                    <div className="relative h-full px-7 flex items-center justify-between gap-4 text-white text-left">
                      ...
                      <div className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-md group-hover:bg-white group-hover:text-amber-950 transition-all shrink-0">
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => showNotification("Đang mở Trợ lý AI pháp luật - Cổng Pháp luật Quốc gia...")}
                  ...
                  >
                    <img
                      ...
                      alt="AI pháp luật"
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-red-950/95 to-transparent group-hover:from-red-900/90 group-hover:to-transparent transition-all duration-500"></div>
                    <div className="relative h-full px-7 flex items-center justify-between gap-4 text-white text-left">
                      <div className="flex-1">
                        <h5 className="text-xl md:text-2xl uppercase font-black tracking-tight leading-snug text-white group-hover:text-yellow-300 transition-colors">
                      ...
                      <div className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-md group-hover:bg-white group-hover:text-red-950 transition-all shrink-0">
                        <ChevronRight size={18} />
                      </div>
                    </div>
                  </motion.div>
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => showNotification("Đang kết nối Cổng thông tin dự án Điện hạt nhân Ninh Thuận...")}
                    className="relative flex-1 min-h-[110px] xl:min-h-[120px] rounded-[24px] overflow-hidden group cursor-pointer border border-slate-200/80 hover:border-red-600/30 hover:shadow-xl transition-all duration-300 w-full"
                  >
                    <img
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => showNotification("Đang kết nối hệ thống Bản đồ số 65 xã, phường, đặc khu...")}
                    className="relative flex-1 min-h-[110px] xl:min-h-[120px] rounded-[24px] overflow-hidden group cursor-pointer border border-slate-200/80 hover:border-red-600/30 hover:shadow-xl transition-all duration-300 w-full"
                  >
                    <img
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => showNotification("Đang kết nối hệ thống Tra cứu giá đất trực tuyến...")}
                    className="relative flex-1 min-h-[110px] xl:min-h-[120px] rounded-[24px] overflow-hidden group cursor-pointer border border-slate-200/80 hover:border-red-600/30 hover:shadow-xl transition-all duration-300 w-full"
                  >
                    <img
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => showNotification("Đang kết nối Cổng công khai ngân sách nhà nước...")}
                    className="relative flex-1 min-h-[110px] xl:min-h-[120px] rounded-[24px] overflow-hidden group cursor-pointer border border-slate-200/80 hover:border-red-600/30 hover:shadow-xl transition-all duration-300 w-full"
                  >
                    <img
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => showNotification("Đang kết nối Cổng Dịch vụ công trực tuyến...")}
                    className="relative flex-1 min-h-[110px] xl:min-h-[120px] rounded-[24px] overflow-hidden group cursor-pointer border border-slate-200/80 hover:border-red-600/30 hover:shadow-xl transition-all duration-300 w-full"
                  >
                    <img
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => showNotification("Đang kết nối Cổng thông tin xúc tiến Du lịch Nha Trang - Khánh Hòa...")}
                    className="relative flex-1 min-h-[110px] xl:min-h-[120px] rounded-[24px] overflow-hidden group cursor-pointer border border-slate-200/80 hover:border-red-600/30 hover:shadow-xl transition-all duration-300 w-full"
                  >
                    <img
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => {
                      showNotification("Đang kết nối đến cổng Cơ sở dữ liệu văn bản quy phạm pháp luật Quốc gia...");
                    }}
                    className="relative flex-1 min-h-[110px] xl:min-h-[120px] rounded-[24px] overflow-hidden group cursor-pointer border border-slate-200/80 hover:border-red-600/30 hover:shadow-xl transition-all duration-300 w-full"
                  >
                    <img
                  ...
                  >
                    <img
                      ...
                      alt="Chuyển đổi số"
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-red-800/90 to-transparent group-hover:from-red-700/90 group-hover:to-transparent transition-all duration-500"></div>
                    <div className="relative h-full px-7 flex items-center justify-between gap-4 text-white text-left">
                      <div className="flex-1">
                        <h5 className="text-xl md:text-2xl uppercase font-black tracking-tight leading-snug text-white group-hover:text-yellow-300 transition-colors">
                      ...
                      <div className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-md group-hover:bg-white group-hover:text-red-900 transition-all shrink-0">
                        <ChevronRight size={18} />
                      </div>
                    </div>
                  </motion.div>
                  ...
                  <motion.div
                    whileHover={{ scale: 1.02, y: -3 }}
                    onClick={() => showNotification("Đang mở Cổng Bảo hiểm Xã hội...")}
                    className="relative flex-1 min-h-[110px] xl:min-h-[120px] rounded-[24px] overflow-hidden group cursor-pointer border border-slate-200/80 hover:border-red-600/30 hover:shadow-xl transition-all duration-300 w-full"
                  >
                    <img
                    ...
                    <div className="relative h-full px-7 flex items-center justify-between gap-4 text-white text-left">
                      ...
                      <div className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-md group-hover:bg-white group-hover:text-rose-900 transition-all shrink-0">
                        <ChevronRight size={18} />
                      </div>
                    </div>
                  </motion.div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-12 gap-8">
                      ...
                      <div className="col-span-8 space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                          <span className="text-base text-red-700 font-bold uppercase tracking-widest mb-2 block">Tiêu điểm Chính phủ</span>
                          <h4 className="text-2xl font-black text-black mb-3">Quyết định số 129/QĐ-TTg phê duyệt đẩy mạnh liên kết vùng duyên hải Nam Trung Bộ</h4>
                          <img src="https://images.unsplash.com/photo-1572025442646-866d16c84a54?q=80&w=1000" alt="News" className="w-full h-64 object-cover rounded-2xl mb-4" />
                          <p className="text-lg text-black leading-relaxed text-justify">
                            Thủ tướng Chính phủ trực tiếp ký kết chỉ thị giao phó tỉnh Khánh Hòa giữ vị thế hạt nhân điều phối, tập trung khai thông du lịch biển liên tỉnh Bắc-Nam, xây dựng cụm logistic quốc tế phục vụ thông thương kinh tế biển sâu sắc.
                          </p>
                        </div>
                        ...
                        <div className="space-y-4">
                          {[1, 2, 3].map((item) => (
                            <div key={item} className="flex gap-4 p-4 bg-white rounded-2xl border border-slate-100 hover:border-red-200 transition-all">
                              <img src="https://images.unsplash.com/photo-1572025442646-866d16c84a54?q=80&w=200" alt="News" className="w-24 h-24 object-cover rounded-xl" />
                              <div className="flex flex-col justify-center">
                                <span className="text-base font-bold text-red-700 uppercase mb-1">Chỉ đạo mới</span>
                                <h5 className="font-bold text-black leading-snug">Văn bản hướng dẫn thi hành luật đất đai số {item}...</h5>
                                <span className="text-base text-black mt-1">19/05/2026</span>
                              </div>
                            </div>
                          ))}
                        </div>
                  ...
                  {activeSubTab === "vandan-tinh" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-3">
                      <span className="text-lg text-red-800/70 font-extrabold uppercase">Quyết định ban hành tỉnh</span>
                      <h4 className="text-lg font-black text-red-800">Ứng phó phòng chống thiên tai và ứng cứu mưa lũ cục bộ, bồi lấp bờ sông dốc cao</h4>
                      <p className="text-lg text-red-800 leading-relaxed font-semibold">
                        Chủ tịch UBND tỉnh chỉ thị Sở Nông nghiệp phối hợp các địa bàn trọng điểm như Khánh Vĩnh, Khánh Sơn rà soát toàn bộ sạt lở bồi lấp, di chuyển hộ dân khẩn trương trước đợt bão lớn xuất hiện.
                      </p>
                      <span className="text-lg text-red-800/70 block font-normal">Ký ban hành lúc 16:30 chiều qua bởi Văn Phòng Tỉnh ủy.</span>
                    </div>
                  )}
                  ...
                  {activeSubTab === "vandan-so" && (
                    <div className="space-y-4">
                      {[
                        { title: "Sở Giao thông: Ban hành kế hoạch dẹp xe dù bến cóc xung quanh ranh thành Nha Trang", agency: "Sở Giao thông Vận tải" },
                        { title: "Sở Du lịch: Công bố số lượng du khách chạm đạt kỷ lục mới 4.5 triệu lượt", agency: "Sở Du lịch" }
                      ].map((n, i) => (
                        <div key={i} className="bg-white p-4.5 rounded-xl border border-red-100 hover:border-red-300 transition-colors">
                          <span className="text-base bg-red-50 text-red-800 px-2 py-0.5 rounded uppercase font-black tracking-widest block w-max mb-1.5">{n.agency}</span>
                          <h5 className="text-lg font-black text-red-950 leading-normal mb-1">{n.title}</h5>
                          <p className="text-lg text-red-900/80 font-medium">Bản tin hoạt động thực hiện chỉ tiêu hành động từ đầu tháng.</p>
                        </div>
                      ))}
                    </div>
                  )}
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-col md:flex-row gap-3">
                        <div className="relative flex-1">
                          ...
                          />
                          <Search size={14} className="absolute left-3 top-3.5 text-red-800/70" />
                        </div>
                        <select
                          value={docFilter}
                      ...
                      <div className="space-y-2 max-h-[320px] overflow-y-auto bg-white p-3 rounded-2xl border border-red-100/50 shadow-inner">
                        {MOCK_DOCS.filter(d => {
                          ...
                          const matchesCat = docFilter === "all" || d.cat === docFilter;
                          ...
                          >
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                <span className="bg-red-600 text-white text-lg font-black px-1.5 py-0.5 rounded">{doc.type}</span>
                                <span className="text-base font-semibold text-red-700">{doc.num}</span>
                              </div>
                              <p className="font-extrabold text-red-950 leading-normal line-clamp-1">{doc.title}</p>
                              <span className="text-base text-red-800/70 font-medium">{doc.date}</span>
                            </div>
                            <ChevronRight size={14} className="text-red-800/70 shrink-0 mt-2" />
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  {activeSubTab === "vandan-media" && (
                    <div className="space-y-4">
                      ...
                      <div className="bg-white p-5 rounded-2xl border border-red-100/50 min-h-[220px]">
                        {mediaTab === "photos" && (
                          <div className="grid grid-cols-2 gap-3">
                            <div className="relative rounded-lg overflow-hidden group">
                              <img src="https://images.unsplash.com/photo-1541807084-5c52b6b3adef?q=80&w=400&auto=format&fit=crop" alt="Hội nghị" className="w-full h-28 object-cover" />
                              <div className="absolute inset-0 bg-black/40 flex items-end p-2"><span className="text-white text-base font-bold line-clamp-1">Ký kết định hướng quy hoạch hành chính công</span></div>
                            </div>
                            <div className="relative rounded-lg overflow-hidden group">
                              <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=400&auto=format&fit=crop" alt="Cơ sở hạ tầng" className="w-full h-28 object-cover" />
                              <div className="absolute inset-0 bg-black/40 flex items-end p-2"><span className="text-white text-base font-bold line-clamp-1">Vận hành trung tâm đô thị thông minh</span></div>
                            </div>
                          </div>
                        )}
                        ...
                        {mediaTab === "videos" && (
                          <div className="relative rounded-xl overflow-hidden aspect-video max-w-sm mx-auto bg-red-950 flex items-center justify-center">
                            <div className="text-center text-white space-y-2 z-10 p-4">
                              <Play className="mx-auto text-red-500 animate-pulse" size={32} />
                              <p className="text-lg font-black uppercase">Đồng thuận xanh và số hóa của cư dân Nha Trang</p>
                            </div>
                            <div className="absolute inset-0 opacity-40 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=400')" }} />
                          </div>
                        )}

                        {mediaTab === "infographics" && (
                          <div className="space-y-4">
                            <h5 className="text-lg font-black text-red-700 tracking-wider uppercase">ĐỒ HỌA CHUYỂN ĐỔI SỐ HÀNH CHÍNH TỈNH:</h5>
                            <div className="space-y-2 text-lg">
                              <div>
                                <div className="flex justify-between text-lg font-bold mb-1">
                                  <span>Hồ sơ liên thông hành chính số trực tuyến</span>
                                  <span className="text-red-700">98.2%</span>
                                </div>
                                <div className="w-full bg-red-50 h-2 rounded-full overflow-hidden">
                                  <div className="bg-red-700 h-full" style={{ width: "98.2%" }} />
                                </div>
                              </div>
                              <div>
                                <div className="flex justify-between text-lg font-bold mb-1">
                                  <span>Giải quyết phản ánh đúng hạn trong 48h</span>
                                  <span className="text-red-700">94.5%</span>
                                </div>
                                <div className="w-full bg-red-50 h-2 rounded-full overflow-hidden">
                                  <div className="bg-red-700 h-full" style={{ width: "94.5%" }} />
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        {mediaTab === "longform" && (
                          <div className="space-y-2 text-lg">
                            <h5 className="font-extrabold text-red-950 text-lg">Khánh Hòa 2026: Trở thành Đô thị Trực thuộc Trung ương thông minh tương lai</h5>
                            <p className="text-red-900/80 leading-relaxed font-semibold">Từng dải tấp lập ven bờ ngọc Nha Trang được tích hợp sâu bởi mạng lưới camera hành chính AI, đảm bảo cuộc sống văn minh bậc nhất...</p>
                            <span className="text-red-700 font-bold hover:underline cursor-pointer">Đọc tiếp đặc san chuyên san ...</span>
                          </div>
                        )}

                        {mediaTab === "audio" && (
                          <div className="flex flex-col items-center justify-center space-y-4 py-4 text-center">
                            <span className="p-3 bg-red-50 rounded-full text-red-700 animate-pulse"><Megaphone size={24} /></span>
                            <div>
                              <p className="text-lg font-black text-red-800">BẢN TIN PHÁT THANH CÔNG BỘC KHÁNH HÒA TUẦN 21</p>
                              <p className="text-lg text-red-800/70 font-medium">Bản thu phát thanh tổng hợp chỉ đạo các ban ngành địa phương.</p>
                            </div>
                            <button
                              onClick={() => setAudioPlaying(!audioPlaying)}
                              className={`px-6 py-2 rounded-xl text-lg font-bold text-white transition-all ${
                                audioPlaying ? "bg-red-700 hover:bg-red-600" : "bg-red-700 hover:bg-red-700"
                              }`}
                            >
                              {audioPlaying ? "⏸ ĐANG PHÁT - DỪNG PHÁT" : "▶ BẮT ĐẦU NGHE TIN PHÁT THANH"}
                            </button>
                          </div>
                        )}
                      </div>
                ...
                <div>
                  {activeSubTab === "congkhai-yk" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4">
                      <h4 className="text-lg font-black text-red-950 uppercase border-b pb-2">LẤY Ý KIẾN CẦN LẬP PHÁP DỰ THẢO VĂN BẢN QPPL</h4>
                      <div className="bg-red-50 text-red-900 border border-red-200 p-4 rounded-xl text-lg space-y-2">
                        <span className="font-bold block uppercase text-red-700">Dự thảo Quy chuẩn rác thải nhựa nông thôn mới 2026</span>
                        <p className="font-semibold text-red-800 leading-relaxed text-justify">
                          Đế án cấm triệt để việc đốt vỏ bao nilon và bình đựng thuốc bảo vệ thực vật tại ao đầm, yêu cầu hộ dân tập kết đúng nơi kiểm dịch trong vòng 24 giờ.
                        </p>
                      </div>

                      <form onSubmit={handlePostComment} className="space-y-3">
                        <label className="text-base uppercase font-black text-red-900/80 tracking-wider block">Ý kiến góp ý công dân:</label>
                        <textarea
                          rows={2}
                          value={newComment}
                          ...
                          required
                        />
                        <button type="submit" className="bg-red-700 text-white px-5 py-2.5 rounded-xl text-lg font-bold hover:bg-red-600 flex items-center gap-1">
                      ...
                      {draftComments.length > 0 && (
                        <div className="space-y-2 mt-4 pt-4 border-t">
                          <span className="text-lg font-black text-red-800/70 uppercase tracking-widest block">Góp ý mới gửi:</span>
                          {draftComments.map((cmt, i) => (
                            <div key={i} className="p-3 bg-red-50/30 rounded-lg text-lg font-semibold text-red-900 border">
                              {cmt}
                            </div>
                          ))}
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {["budget", "tender", "investment", "socio"].map((tab) => (
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-lg uppercase font-extrabold tracking-wide ${
                              infoPublicTab === tab ? "bg-red-900 text-white" : "bg-red-50 text-red-800"
                            }`}
                          >
                      ...
                      <div className="bg-white p-5 rounded-2xl border border-red-100/50 min-h-[220px] text-lg space-y-4">
                        {infoPublicTab === "budget" && (
                          <div className="space-y-3">
                            <h5 className="font-bold text-red-900">Công khai ngân sách cấp phát năm tài chính 2026:</h5>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-lg font-semibold text-red-800">
                              <div className="p-3 bg-yellow-50 text-amber-800 rounded-lg">Tổng thu ngân sách nhà nước: 18,450 Tỷ VNĐ</div>
                              <div className="p-3 bg-red-50 text-red-800 rounded-lg">Tổng chi phát hành xã hội: 14,210 Tỷ VNĐ</div>
                            </div>
                            <div className="p-3.5 bg-red-50/30 rounded-xl space-y-1">
                              <div className="flex justify-between font-black text-lg"><span>Tỷ lệ phân giải đền bù cao tốc</span><span>84.2%</span></div>
                              <div className="w-full bg-red-100 h-2 rounded-full overflow-hidden">
                                <div className="bg-amber-500 h-full" style={{ width: "84.2%" }} />
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {infoPublicTab === "tender" && (
                          <div className="space-y-3">
                            <h5 className="font-bold text-red-900">Gói thầu mua sắm công nghiệp đang vận hành:</h5>
                            {[
                              { label: "Mã thầu: KH-2026-00412", title: "Cung cấp máy móc y học hiện đại cho Bệnh viện Đa khoa Cam Ranh" },
                              { label: "Mã thầu: KH-2026-00550", title: "Bảo trì nâng cấp lòng đường dải hành lang tránh lũ lộ Diên Khánh" }
                            ].map((ten, i) => (
                              <div key={i} className="p-3 bg-red-50/30 rounded-lg border flex justify-between items-center text-lg font-semibold">
                                <div>
                                  <span className="text-red-700 block text-lg font-black uppercase mb-0.5">{ten.label}</span>
                                  <span className="text-red-950 block">{ten.title}</span>
                                </div>
                                <span className="text-lg bg-red-100 text-red-800 py-1 px-2.5 rounded-md uppercase font-black shrink-0 tracking-wider">HỒ SƠ MỞ</span>
                              </div>
                            ))}
                          </div>
                        )}
                        ...
                        {infoPublicTab === "investment" && (
                          <div className="space-y-3/2">
                            <h5 className="font-bold text-red-900">Danh mục Đề án FDI và Đầu tư trọng điểm hạ tầng:</h5>
                            <div className="p-3 bg-red-50/30 border-l-4 border-red-700 rounded-r-lg">
                              <span className="font-black text-red-950 block text-lg">Xây dựng Khu công nghệ sinh học biển Nha Trang</span>
                              <p className="text-base text-red-800/70 mt-1 leading-snug">Chủ quản: Viện Hải dương học phối hợp Sở Khoa học. Số vốn: 12.4 Triệu USD.</p>
                            </div>
                          </div>
                        )}
                        ...
                        {infoPublicTab === "socio" && (
                          <div className="space-y-2">
                            <h5 className="font-bold text-red-900">Báo cáo chỉ số kinh tế chung của Tỉnh:</h5>
                            <p className="text-red-900/80 leading-relaxed font-semibold italic">"Khánh Hòa đạt mức chỉ số tăng trưởng công thương dịch vụ GRDP tăng +8.45% so với cùng kỳ năm trước, thuộc nhóm các địa bàn biển phát triển năng động nhất duyên hải."</p>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  {activeSubTab === "congkhai-tt" && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        { title: "Phổ biến Hiến pháp & Luật Đất đai mới 2024 sửa đổi", d: "Cung cấp cẩm nang tra cứu và quyền thu hồi đền bù cho cư dân." },
                        { title: "Cải cách hành chính tích hợp định danh VNeID", d: "Giảm tối thiểu toàn bộ các khâu thủ tục nộp giấy trực tiếp." },
                        { title: "An toàn giao thông: Đã phạt nguội xe cơ giới vượt tốc tốc độ Trần Phú", d: "Tạo nếp sống văn minh an khang của thành phố du lịch văn hóa." }
                      ].map((card, i) => (
                        <div key={i} className="bg-white p-5 rounded-xl border border-red-100 relative overflow-hidden flex flex-col justify-between">
                          <div>
                            <h5 className="text-lg font-black text-red-800 mb-2 leading-snug">{card.title}</h5>
                            <p className="text-lg text-red-800/70 leading-normal font-semibold text-justify">{card.d}</p>
                          </div>
                          <span className="text-lg text-red-700 font-black cursor-pointer uppercase tracking-wider block mt-4 hover:underline">Xem tư liệu →</span>
                        </div>
                      ))}
                    </div>
                  )}
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4">
                        <h4 className="text-lg font-black text-red-800 uppercase border-b pb-1.5 flex items-center gap-1.5">
                          <CheckCircle2 size={13} className="text-red-700" /> CỔNG TRA CỨU BẢO HIỂM XÃ HỘI (SI PHÁT SỐ)
                        </h4>
                        <form onSubmit={handleLookupSocial} className="flex gap-2">
                          ...
                          />
                          <button type="submit" className="bg-red-700 text-white px-5 rounded-xl text-lg font-bold hover:bg-red-700">
                            Truy nguyên
                          </button>
                        </form>
                        {socialResult && (
                          <div className="p-3.5 bg-red-50 text-red-900 rounded-xl space-y-1.5 border border-red-250 text-lg font-semibold shadow-inner">
                            <div><strong>Người thụ hưởng:</strong> {socialResult.fullName}</div>
                            <div><strong>Đến số CCCD:</strong> {socialResult.cardId}</div>
                            <div><strong>Nhóm định loại:</strong> {socialResult.type}</div>
                            <div><strong>Quá trình tích:</strong> {socialResult.timeline}</div>
                            <div className="text-red-700 font-bold">● Trạng thái: {socialResult.status}</div>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4">
                        <h4 className="text-lg font-black text-red-800 uppercase border-b pb-1.5 flex items-center gap-1.5">
                          <Layers size={13} className="text-red-700" /> BẢNG GIÁ ĐẤT TỈNH QUY ĐỊNH
                        </h4>
                        <form onSubmit={handleLookupLandPrice} className="flex gap-2">
                          <select
                            value={landStreet}
                          ...
                          >
                            <option value="Trần Phú">Đường Trần Phú (Nha Trang)</option>
                            <option value="Hùng Vương">Đường Hùng Vương (Nha Trang)</option>
                            <option value="Vân Đồn">Đường Vân Đồn (Nha Trang)</option>
                            <option value="Lê Thánh Tôn">Đường Lê Thánh Tôn (Nha Trang)</option>
                            <option value="Phạm Văn Đồng">Đường Phạm Văn Đồng (Nha Trang)</option>
                          </select>
                          <button type="submit" className="bg-red-700 text-white px-5 rounded-xl text-lg font-bold hover:bg-red-700">
                            Tính giá đất
                          </button>
                        ...
                        {landPriceResult && (
                          <div className="p-3.5 bg-red-50 text-red-900 rounded-xl flex justify-between items-center text-lg font-bold border border-red-150">
                            ...
                            <span className="text-lg font-black text-red-700">{landPriceResult.price}</span>
                          </div>
                        )}
                      </div>
                    </div>
              ...
              {activePillar.id === "dichvu" && (
                <div>
                  {activeSubTab === "dichvu-hd" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4">
                      <h4 className="text-lg font-black text-red-800 uppercase border-b pb-2">CHUYÊN MỤC HỎI ĐÁP Ý KIẾN CỦ TRÍ QUẢN LÝ</h4>
                      <div className="space-y-4 max-h-[220px] overflow-y-auto pr-2">
                        {qaList.map((qa, i) => (
                          <div key={i} className="p-3 bg-red-50/30 rounded-xl space-y-2 border">
                            <div className="font-extrabold text-lg text-red-700 flex gap-1 items-start">
                              <span className="bg-red-650 text-white font-black text-lg px-1 rounded block mt-0.5 shrink-0">HỎI</span>
                            ...
                            <div className="text-lg leading-relaxed text-red-800 font-semibold flex gap-1 items-start border-t border-dashed pt-2">
                              <span className="bg-red-700 text-white font-black text-lg px-1 rounded block mt-0.5 shrink-0">ĐÁP</span>
                              <p className="text-left text-justify text-red-800">{qa.a}</p>
                            </div>
                          </div>
                        ))}
                      </div>

                      <form onSubmit={handlePostQa} className="space-y-3 pt-3 border-t">
                        <textarea
                          rows={2}
                          value={qaInput}
                          ...
                          required
                        />
                        <button type="submit" className="bg-red-700 text-white px-5 py-2 rounded-xl text-lg font-bold hover:bg-red-600">
                  ...
                  {activeSubTab === "dichvu-online" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4">
                      <h4 className="text-lg font-black text-red-800 uppercase border-b pb-2">CỔNG DỊCH VỤ CÔNG LIÊN THÔNG QUỐC GIA</h4>
                      <p className="text-lg text-red-900/80 font-semibold col-span-2">Chọn thủ tục cần xử lý và thực hiện điền thông tin định danh trực tuyến:</p>
                      ...
                      {!selectedService ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          {[
                            ...
                            <button
                              key={i}
                              onClick={() => { setSelectedService(serv); setServiceStep(1); setAppliedCode(null); }}
                            ...
                            >
                              ...
                              <ChevronRightSquare size={16} className="text-red-200 shrink-0" />
                            </button>
                          ))}
                        </div>
                      ) : (
                        <form onSubmit={handleApplyService} className="space-y-4 border border-dashed border-red-200 p-4 rounded-xl text-lg font-semibold">
                          <div className="flex justify-between items-center border-b pb-2 mb-2">
                            <span className="font-bold text-red-700 flex items-center gap-1"><Sparkles size={13} /> {selectedService}</span>
                            <button type="button" onClick={() => setSelectedService(null)} className="text-red-800/70 hover:text-red-800"><X size={14} /></button>
                          </div>

                          {appliedCode ? (
                            <div className="py-4 text-center space-y-3">
                              <span className="p-3 bg-yellow-50 rounded-full text-amber-600 inline-block"><CheckCircle size={32} /></span>
                              <h5 className="font-extrabold text-red-700 text-lg">GỬI HỒ SƠ THÀNH CÔNG MIỄN PHÍ!</h5>
                              <p className="text-red-900/80 text-lg leading-relaxed max-w-xs mx-auto">Mã hồ sơ định danh của bạn là <strong>{appliedCode}</strong>. Công chức sẽ tiến hành rà soát cấp phép bản mềm dạng QR định hướng trong vòng 24 giờ hành chính.</p>
                            </div>
                          ) : (
                            <div className="space-y-3 text-left">
                              {serviceStep === 1 ? (
                                <div className="space-y-3">
                                  <div>
                                    <label className="block text-lg text-red-800/70 font-extrabold uppercase mb-1">Họ tên người đề nghị</label>
                                    <input type="text" placeholder="NGUYỄN VĂN AN..." value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} className="w-full bg-red-50/30 border p-2.5 rounded-lg text-lg font-bold" required />
                                  </div>
                                  <div>
                                    <label className="block text-lg text-red-800/70 font-extrabold uppercase mb-1">Mã định danh cá nhân CCCD</label>
                                    <input type="text" placeholder="056096001235..." value={formData.cardId} onChange={e => setFormData({...formData, cardId: e.target.value})} className="w-full bg-red-50/30 border p-2.5 rounded-lg text-lg font-bold" required />
                                  </div>
                                  <button type="submit" className="w-full bg-red-750 text-white py-2.5 rounded-lg text-lg font-bold hover:bg-red-600">Tiếp tục kê khai bước 2 →</button>
                                </div>
                              ) : (
                                <div className="space-y-3">
                                  <div>
                                    <label className="block text-lg text-red-800/70 font-extrabold uppercase mb-1">Mô tả lý do / Trực trạng xin giấy phép</label>
                                    <textarea rows={2} value={formData.address} onChange={e => setFormData({...formData, address: e.target.value})} placeholder="Cam kết xây dựng theo đúng thỏa đồ bản ..." className="w-full bg-red-50/30 border p-2.5 rounded-lg text-lg font-bold" />
                                  </div>
                                  <div className="flex gap-2 items-center">
                                    <input type="checkbox" checked={formData.agreed} onChange={e => setFormData({...formData, agreed: e.target.checked})} className="scale-110" id="agree-chinh-quyen" />
                                    <label htmlFor="agree-chinh-quyen" className="text-base text-red-900/80 font-bold select-none cursor-pointer">Tôi xin cam đoan các thông tin kê khai là thật.</label>
                                  </div>
                                  <div className="flex gap-2 pt-2 border-t">
                                    <button type="button" onClick={() => setServiceStep(1)} className="bg-red-100 text-red-800 px-4 py-2 rounded-lg text-lg font-bold flex-1">Quay lại</button>
                                    <button type="submit" className="bg-red-750 text-white px-4 py-2 rounded-lg text-lg font-bold flex-1">Nộp hồ sơ ngay ✓</button>
                                  </div>
                                </div>
                              )}
                            </div>
                  ...
                  {activeSubTab === "dichvu-tiepnhan" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4 text-lg font-bold">
                      <h4 className="text-lg font-black text-red-800 uppercase border-b pb-2">TIẾP NHẬN PHẢN HỒI Ý KIẾN CÔNG DÂN & DOANH NGHIỆP</h4>
                      <p className="text-red-900/80 font-semibold leading-relaxed text-justify">
                        Hệ thống đã tự động liên kết với trung tâm xử lý phản ánh thực hiện chuyển giao trách nhiệm. Quý công dân và đơn vị doanh nghiệp xin vui lòng sử dụng biểu mẫu nộp phản ánh hiện trường ngoài trang chính để nhận phiếu xử lý định hướng cụ thể.
                      </p>
                      <div className="p-4 bg-red-50 text-red-900 border border-red-150 rounded-xl">
                        Tổng số lượng kiến nghị đã tiếp nhận và phân giải giải quyết tính đến tháng 5/2026: <strong>14,250 trường hợp</strong> (Đạt tỷ lệ dứt điểm 92.4%).
                      </div>
                    </div>
                  )}
                  ...
                  {activeSubTab === "dichvu-congbao" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-3 text-lg">
                      <h4 className="text-lg font-black text-red-800 uppercase border-b pb-2">CƠ SỞ DỮ LIỆU QUỐC GIA & CÔNG BÁO CHÍNH THỨC</h4>
                      <p className="text-red-900/80 font-semibold">Cửa ngõ kết nối cơ quan lập pháp: kết nối chính thức đến kho chứa dữ liệu chính trị quốc gia nước Cộng hòa Xã hội Chủ nghĩa Việt Nam.</p>
                      <div className="p-3 bg-red-50/30 rounded-lg flex items-center justify-between border-red-200 border cursor-pointer hover:border-red-300" onClick={() => showNotification("Chuyển liên kết CSDL hành chính quốc gia!")}>
                        <span className="font-extrabold text-red-700">● Trang Công báo nước Cộng hòa XHCN Việt Nam</span>
                        <ExternalLink size={13} className="text-red-800/70" />
                      </div>
                      <div className="p-3 bg-red-50/30 rounded-lg flex items-center justify-between border-red-200 border cursor-pointer hover:border-red-300" onClick={() => showNotification("Chuyển liên kết văn bản pháp quy quốc gia!")}>
                        <span className="font-extrabold text-red-700">● Cơ sở dữ liệu quốc gia về văn bản quy phạm pháp luật</span>
                        <ExternalLink size={13} className="text-red-800/70" />
                      </div>
                    </div>
                  )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-white text-red-700 p-6 rounded-2xl shadow-md text-center space-y-3 relative overflow-hidden flex flex-col justify-center min-h-[160px] border border-red-100">
                        ...
                        <p className="text-lg text-black leading-relaxed font-semibold max-w-md mx-auto">
                          Chào mừng 51 năm Ngày thống nhất đất nước và Giải phóng hoàn toàn miền Nam, thống nhất Tổ quốc (30/04/1975 - 30/04/2026).
                        </p>
                      </div>

                      {/* Bản Tin Tuần */}
                      <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-3">
                        <span className="text-lg bg-red-100 text-red-800 px-2 py-0.5 rounded uppercase font-black tracking-widest">Bản tin truyền thông tổng hợp</span>
                        <h4 className="text-lg font-black text-red-800">Điểm tin hoạt động nổi bật, sự kiện chủ chốt toàn tỉnh Khánh Hòa tuần vừa qua</h4>
                        <p className="text-lg text-red-900/80 leading-relaxed font-semibold text-justify">
                          Trong tuần qua, Tỉnh tổ chức xúc tiến FDI thành công, khởi động hạ tầng chuyển đổi hành chính số liên huyện, xử lý nhanh sạt lở bồi lấp bờ sông dốc cao, đảm bảo toàn thể an cư sinh kế của dân cư trong thời gian mưa lũ bất ngờ.
                        </p>
                      </div>
                    </div>
                  )}
              ...
              {activePillar.id === "bando" && (
                <div>
                  {activeSubTab === "bando-filter" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4">
                      <h4 className="text-lg font-black text-red-800 uppercase border-b pb-2">MẠNG LƯỚI LIÊN KẾT WEBSITE ĐƠN VỊ NGOÀI PORTAL</h4>
                      <div className="space-y-3">
                        <label className="text-base uppercase font-black text-red-800 tracking-wider block">Chọn Cấp/Sở ban ngành cần liên kết điện tử:</label>
                        <select
                          value={webLinkGroup}
                          onChange={(e) => {
                            setWebLinkGroup(e.target.value);
                            if (e.target.value) {
                              showNotification(`Mô phỏng: Chuyển hướng thành công sang trang ${e.target.value}.gov.vn của Tỉnh!`);
                            }
                          }}
                          className="w-full bg-red-50/30 border p-3 rounded-xl text-lg font-bold text-red-900 focus:outline-[#EA580C]"
                        >
                          <option value="">-- Chọn Đơn vị chức năng cần liên kết --</option>
                          <option value="Sở Kế hoạch và Đầu tư">Sở Kế hoạch và Đầu tư (sokhdt.khanhhoa.gov.vn)</option>
                          <option value="Sở Tài chính">Sở Tài chính (sotaichinh.khanhhoa.gov.vn)</option>
                          <option value="Sở Tư pháp">Sở Tư pháp (sotuphap.khanhhoa.gov.vn)</option>
                          <option value="UBND Thành Phố Nha Trang">UBND Thành Phố Nha Trang (nhatrang.gov.vn)</option>
                          <option value="UBND Huyện Vạn Ninh">UBND Huyện Vạn Ninh (vanninh.gov.vn)</option>
                        </select>
                      </div>
                    </div>
                  )}
                  ...
                  {activeSubTab === "bando-poll" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4">
                      <h4 className="text-lg font-black text-red-800 uppercase border-b pb-2">THĂM DÒ Ý KIẾN: ĐỊNH HƯỚNG QUY HOẠCH PHÁT TRIỂN TIÊN PHONG</h4>
                      <p className="text-lg text-red-900/80 font-semibold leading-relaxed">
                        Bạn đánh giá lĩnh vực nào cần đun đẩy nâng cấp cải tiến triệt để nhất tại đô thị Khánh Hòa thời gian tới?
                      </p>

                      <form onSubmit={handleVote} className="space-y-3 text-lg font-bold">
                        {[
                          { id: "xa-choi", label: "Hạ tầng phục vụ xã hội và an sinh an khang cử tri", res: pollResults.xaHoi },
                          { id: "moi-truong", label: "Bảo tồn môi trường biển, xử lý rác thải vịnh", res: pollResults.moiTruong },
                          { id: "ha-tang", label: "Cải cách thủ tục một cửa hành chính", res: pollResults.haTang }
                        ].map((choice) => (
                          <div key={choice.id} className="p-3 bg-red-50/30 rounded-xl flex items-center justify-between border cursor-pointer hover:border-red-400" onClick={() => setPoleValue(choice.id)}>
                            <div className="flex gap-2 items-center">
                              <input type="radio" name="poll" checked={poleValue === choice.id} onChange={() => setPoleValue(choice.id)} readOnly />
                              <span className="text-red-900 leading-tight">{choice.label}</span>
                            </div>
                            {voted && (
                              <span className="text-red-700 text-lg font-black shrink-0">{choice.res} lượt bình chọn</span>
                            )}
                          </div>
                        ))}

                        {!voted ? (
                          <button type="submit" className="bg-red-700 text-white px-6 py-2.5 rounded-xl text-lg font-bold hover:bg-red-700">
                          ...
                          <div className="p-3 bg-yellow-50 text-amber-800 text-lg rounded-xl font-bold border border-amber-200/60">
                            Cảm ơn bạn! Cuộc khảo sát đã cập nhật tỷ lệ dân cư bình chọn.
                          </div>
                        )}
                      </form>
                    </div>
                  ...
                  {activeSubTab === "bando-sponsor" && (
                    <div className="bg-white p-5 rounded-2xl border border-red-100/50 shadow-sm space-y-4">
                      <h4 className="text-lg font-black text-red-700 uppercase border-b pb-2">HỖ TRỢ QUẢNG BÁ SẢN PHẨM DOANH NGHIỆP ĐỊA PHƯƠNG (OCOP)</h4>
                      <p className="text-lg text-red-900/80 font-medium leading-relaxed">Trưng bày nông - lâm - thủy - hải sản sạch đạt chứng thức OCOP tiêu chuẩn Quốc gia:</p>
                      <div className="grid grid-cols-2 gap-3 text-lg">
                        <div className="p-3 bg-red-50/20 border border-red-100 rounded-xl space-y-1">
                          <span className="text-red-700 font-black tracking-widest block text-lg">OCOP 5 SAO ★★★★★</span>
                          <strong>Yến sào Khánh Hòa tự nhiên</strong>
                          <span className="text-base text-red-800/70 block font-normal">Sản vật quý thiên nhiên ban tặng vịnh biển hoang sơ dã.</span>
                        </div>
                        <div className="p-3 bg-red-50/20 border border-red-100 rounded-xl space-y-1">
                          <span className="text-red-700 font-black tracking-widest block text-lg">OCOP 4 SAO ★★★★</span>
                          <strong>Xoài chín cát Cam Lâm thơm ngon</strong>
                          <span className="text-base text-red-800/70 block font-normal">Xoài Úc thâm quả, ngọt dịu nhẹ, phục vụ xuất khẩu quốc tế.</span>
                        </div>
                      </div>
                    </div>
                  )}
            ...
            >
              <div className="bg-red-600 text-white py-4 px-6 flex items-center justify-between">
                <span className="text-lg font-black uppercase flex items-center gap-2">
                  <FileText size={18} className="text-red-400" /> Bản xem văn bản chính quy phạm
                </span>
                <button
              ...
              <div className="bg-red-50/30 py-4 px-6 border-t border-red-100/50 flex justify-end gap-3 rounded-b-3xl">
                ...
                <button
                  onClick={() => {
                    showNotification(`Đã gửi yêu cầu tải số hóa: ${readingDoc.num}.pdf thành công!`);
                    setReadingDoc(null);
                  }}
